...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public CustomUserDetailsService(MemberProfileRepository memberProfileRepository) {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        Optional<MemberProfile> userData = memberProfileRepository.findByNickname(username);
