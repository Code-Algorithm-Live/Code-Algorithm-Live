    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/ws/**","/login", "/member/**", "/chat/**","/member/login","/member/signup", "/member/dupcheck/**","/v3/api-docs", "/api-docs/**", "/swagger-ui/**", "/favicon.ico", "/api/authenticate").permitAll()
