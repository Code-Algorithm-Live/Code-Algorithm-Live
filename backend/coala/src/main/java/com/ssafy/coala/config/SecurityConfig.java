    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
                ...
                .cors((cors)->cors
                        .configurationSource(new CorsConfigurationSource() {
                            ...
                            public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                                ...
                                configuration.setAllowedOrigins(Collections.singletonList("https://i10a709.p.ssafy.io"));
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/ws/**","/login", "/api/**", "/member/**", "/chat/**","/member/login","/member/signup", "/member/dupcheck/**","/v3/api-docs", "/api-docs/**", "/swagger-ui/**", "/favicon.ico", "/api/authenticate", "/v3/api-docs/swagger-config").permitAll()
