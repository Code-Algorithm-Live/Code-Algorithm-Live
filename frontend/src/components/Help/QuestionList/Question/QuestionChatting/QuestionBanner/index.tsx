...
import HelpQuestionModal from '@/components/Help/QuestionList/Question/QuestionChatting/QuestionBanner/HelpQuestionModal';
...
const QuestionBanner = () => {
  const { zustandHistoryTitle, zustandHistoryContent } =
      ...
      <QuestionBannerContainer>
        <div className="questionBanner">
          <div className="titleContainer">
            <p
              ...
              dangerouslySetInnerHTML={{
                __html: zustandHistoryTitle as TrustedHTML,
              }}
            />
          ...
          <p
            className="content"
            dangerouslySetInnerHTML={{
              __html: zustandHistoryContent as TrustedHTML,
            }}
          />
        </div>
      </QuestionBannerContainer>
      <HelpQuestionModal isOpen={isModalOpen} onClose={handleClose} />
    </>
  );
};
